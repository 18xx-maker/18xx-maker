...
const atoms = [{
  ...
  examples: [
    ...
    {track: [{side:1,type:"straightStop"}]},
    {track: [{side:1,type:"straightHalfGentle"}]},
    {track: [{side:3,type:"gentle",gauge:"narrow"}]},
    {track: [{side:5,type:"gentleStop"},
             {side:5,type:"gentleStopRev"}]},
    {track: [{side:3, type:"straightGentleHalf", gauge: "dual"},
             {side:2, type:"gentleHalf", gauge: "dual"},
             {side:6, type:"straightGentleHalf", gauge: "dual"},
             {side:1, type:"gentleHalfRev",  gauge: "dual"}],
