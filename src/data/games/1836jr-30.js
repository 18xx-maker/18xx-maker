const game = {
  ...
  privates: [
    ...
    },
    {
      ...
      revenue: "F20",
      description:
      "Blocks Hex G7, G9 and H10. Owner may exchange for a share of the Etat Belge (this closes the private company)."
    },
    {
    ...
    {
      name: "Chemin de Fer de Lille Á Valenciennes - CFLV",
      price: "F220",
      revenue: "F30",
      description:
  ...
  map: [{
    ...
    hexes: [
      ...
      {
        color: "plain",
        companies: [{label:"CFLV", angle: 165,
                     left: 35, percent: 0.8}],
        hexes: ["J4"]
      },
      {
      ...
      },
      {
        ...
        companies: [{label:"CFL", angle: 195,
                     right: 35, percent: 0.8}],
        hexes: ["K11"]
      },
      {
        color: "offboard",
