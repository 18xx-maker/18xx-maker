...
const atoms = [{
  ...
  examples: [
    ...
    {track: [{ type:"gentleInner", side:1, radiusOffset:40 },
             { type:"gentle", side:1, radiusOffset:40 },
             { type:"gentleOuter", side:1, radiusOffset:40 },
             { type:"gentleInner", side:4, radiusOffset:40 },
             { type:"gentle", side:4, radiusOffset:40 },
             { type:"gentleOuter", side:4, radiusOffset:40 }]},
