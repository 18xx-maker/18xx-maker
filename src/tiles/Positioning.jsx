...
const positions = [
  ...
  },
  {
    ...
    description:
      "This allows you to place elements using polar coordinates which is often much nicer when working in hexes.",
    examples: [
      { centerTowns: [{}] },
  ...
  },
  {
    group: "Sides",
    description:
      "Side is an alias for rotation multiplied by 60. This is useful when placing hex size objects like track.",
    examples: [
      { track: [{ side: 1 }] },
      { track: [{ side: 2 }] },
      { track: [{ side: 3 }] },
...
const Positioning = () => {
  return (
    <>
      <div className="atoms">{groups(positions)}</div>
    </>
  );
};
