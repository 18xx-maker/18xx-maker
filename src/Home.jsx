...
const Home = () => {
  ...
  return (
    <div className="home">
      ...
      <p><strong>Important:</strong> Please use this site to print copies of games for which you already
        have a license by owning a version of the game. Information about games
        which are available for free print and play can be found <a href="https://boardgamegeek.com/geeklist/58420/18xx-available-pnp">on this geeklist</a>.</p>
      <p><strong>Note:</strong> Some games are still works in progress and in general the rendering of stock markets is not in a good place. Work will continue on this stuff.</p>
      <h2>Games</h2>
      <ul>
        {gameNodes}
      </ul>
